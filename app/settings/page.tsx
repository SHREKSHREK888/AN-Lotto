      ...
      <div className="flex-1 flex flex-col lg:ml-0 pt-16 lg:pt-0">
        <main className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
          <div className="mx-auto max-w-4xl space-y-6">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-red-700">ตั้งค่า</h1>
                <p className="text-slate-600">จัดการการตั้งค่าระบบ</p>
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border border-slate-200 shadow-md bg-white/95">
            <CardHeader>
              <CardTitle className="text-red-700">ข้อมูลร้าน</CardTitle>
              <CardDescription>ข้อมูลพื้นฐานของร้านค้า</CardDescription>
            </CardHeader>
          ...
          <Card className="border border-slate-200 shadow-md bg-white/95">
            <CardHeader>
              ...
              <CardDescription>เลือกธีมสีที่ต้องการใช้ในระบบ</CardDescription>
            </CardHeader>
            <CardContent>
              {!selectedTheme ? (
          ...
          <Card className="border border-slate-200 shadow-md bg-white/95">
            <CardHeader>
              <CardTitle className="text-red-700">การตั้งค่าระบบ</CardTitle>
              <CardDescription>ปรับแต่งการทำงานของระบบ</CardDescription>
            </CardHeader>
          ...
          <Card className="border border-slate-200 shadow-md bg-white/95">
            <CardHeader>
              <CardTitle className="text-red-700">ความปลอดภัย</CardTitle>
              <CardDescription>จัดการรหัสผ่านและ PIN</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card className="border border-slate-200 shadow-md bg-white/95">
            <CardHeader>
              <CardTitle className="text-red-700">จัดการข้อมูล</CardTitle>
              <CardDescription>การจัดการและสำรองข้อมูล</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
